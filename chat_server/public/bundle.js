...
var Application = function (_React$Component) {
  ...
  function Application() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Application.__proto__ || Object.getPrototypeOf(Application)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      username: '',
      email: ''
    }, _this.handleSocketOpen = function () {
      _this.setState({ connected: true });
    }, _this.handleSocketClose = function () {
      _this.setState({ connected: false });
    }, _this.handleSocketMessage = function (e) {
      var newPayload = JSON.parse(e.data);
      _this.setState({ payloads: _this.state.payloads.concat([newPayload]) });
    }, _this.handleSocketError = function (err) {
      console.log(err);
  ...
  _createClass(Application, [{
    ...
    // whenever componentDidMount we will instantiate a new websocket
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            'Email:',
            _react2.default.createElement('input', { type: 'text', name: 'email', onChange: this.handleEmailChange, value: this.state.email })
          ),
          _react2.default.createElement(
            'label',
            null,
            'Username:',
            _react2.default.createElement('input', { type: 'text', name: 'username', onChange: this.handleUsernameChange, value: this.state.username })
          ),
          _react2.default.createElement(
            'label',
            null,
            'Message:',
            _react2.default.createElement('input', { type: 'text', name: 'message', onChange: this.handleMessageChange, value: this.state.message })
          ),
    ...
    key: 'messageRecordList',
    get: function get() {
      return this.state.payloads.map(function (payload) {
        return _react2.default.createElement(
          'p',
...
document.addEventListener('DOMContentLoaded', function () {
  _reactDom2.default.render(_react2.default.createElement(Application, null), document.getElementById('react-root'));
});
